...
class Settings(BaseSettings):
    ...
    competitor_room_price_schedule_enabled: bool = True
    competitor_room_price_schedule_interval_minutes: int = 120
    competitor_room_price_schedule_max_hotels_per_shop: int = 20
    competitor_room_price_schedule_headless: bool = True
    competitor_room_price_schedule_debug_url: str = "http://127.0.0.1:9222"
