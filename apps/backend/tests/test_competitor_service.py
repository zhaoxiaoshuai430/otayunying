...
class CompetitorRouteTestCase(unittest.TestCase):
    def test_guest_login_route_rejected_after_feature_removal(self) -> None:
        ...
        self.assertEqual(
            data['detail'],
            'guest automated login has been removed; use the logged-in browser page capture flow instead',
        )
